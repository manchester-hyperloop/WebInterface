...
<body>
	...
	<h2>TurtleSim Controller</h2>
	<form name="ctrlPanel">
		<table>
			<tr><td>Linear</td><td><input id="linearXText" name="linearXText" type="text" value="1.5"/></td></tr>
			<tr><td>Angular</td><td><input id="angularZText" name="angularZText" type="text" value="1.5"/></td></tr>
		</table>
		<button id="sendMsg" type="button" onclick="pubMessage()">Publish</button>
	</form>
	<div id="feedback"></div>
</body>
</html>
